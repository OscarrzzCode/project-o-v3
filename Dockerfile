...
ADD https://github.com/balazik/ComfyUI-PuLID-Flux/archive/refs/heads/main.zip /tmp/pulid-flux.zip
RUN unzip -q /tmp/pulid-flux.zip && mv ComfyUI-PuLID-Flux-main ComfyUI-PuLID-Flux && rm /tmp/pulid-flux.zip
